...
const registrar = async (req, res) =>{
    ...
    try {
        ...
        //Si salio bien el registro, enviamos email
        emailRegistro({
            email,
            nombre,
...
const comprobarToken = async (req, res) =>{
    ...
    //No usamos TryCatch porque no estamos haciendo cambios en la DB
    if(tokenValido){
...
const nuevoPassword = async (req, res) =>{
    const {token} = req.params; //params es la info de la URL
